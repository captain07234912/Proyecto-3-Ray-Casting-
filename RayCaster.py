...
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
SPRITE_BACKGROUND = (181, 230, 29, 255)

textures = {
    '1': pygame.image.load('imagenes/Muro1.jpeg'),
    '2': pygame.image.load('imagenes/Muro2.jpeg'),
    '3': pygame.image.load('imagenes/Muro3.jpeg'),
    '4': pygame.image.load('imagenes/Muro4.jpeg'),
    '5': pygame.image.load('imagenes/Muro5.jpeg')
}

enemies = [{"x": 425,
            "y": 75,
            "texture": pygame.image.load('imagenes/N-Amigo1.png')},

           {"x": 175,
            "y": 175,
            "texture": pygame.image.load('imagenes/N-Amigo2.png')},

           {"x": 100,
            "y": 375,
            "texture": pygame.image.load('imagenes/N-Amigo3.png')},

            {"x": 75,
             "y": 75,
            "texture": pygame.image.load('imagenes/N-Amigo4.png')}
           ]
